...
[Live demo site](https://boorussia.github.io/headroom/) · [Download latest release](https://github.com/BooRussia/headroom/releases/latest)
...
Grab the latest `Headroom-macOS.zip` from [Releases](https://github.com/BooRussia/headroom/releases/latest), unzip, and open `Headroom.app`.
